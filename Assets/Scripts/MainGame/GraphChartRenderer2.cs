...
public class GraphChartRenderer2 : MonoBehaviour
{
    public GraphChart graph;

    // In Unity, Graph object, in the inspector, find the Data section of 'GraphChart'
    // You will see 3 types of data: Line1, Line2, Line3
    private string[] categoryNames = { "Line1", "Line2", "Line3", "Line4", "Line4" };
    ...
    public void DrawTrack()
    {
        ...
        if (graph != null)
        {
            ...
            for (int index = 0; index <= 2; index++) // Loop through indices 0 to 2
            {
